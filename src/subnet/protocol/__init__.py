...
MODEL_KIND_MONEY_FLOW_TYPE_ARCHIVE = "archive"
MODEL_KIND_MONEY_FLOW_TYPE_LIVE = "live"


def get_model_kinds():
    return [MODEL_KIND_MONEY_FLOW, MODEL_KIND_TRANSACTION_STREAM, MODEL_KIND_BALANCE_TRACKING]
